...
const BlogTOC = ({ items, activeSection, readingProgress, title = "Table of Contents", showProgress = true }) => {
  ...
  console.log('[BlogTOC] Rendering with items:', items.length, items);

  if (!items || items.length === 0) {
    console.log('[BlogTOC] No items to display');
    return null;
  }

  return (
    <div className="blog-toc-container bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
      <div className="mb-6">

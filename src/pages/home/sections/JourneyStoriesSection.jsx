...
const JourneyStoriesSection = memo(() => {
  ...
  return (
    <section id="journey-stories" className="relative py-10 sm:py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-100 via-blue-50 to-emerald-50">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-8 sm:mb-10">
          <AnimatedText
            text="Journey Stories"
            className="text-2xl sm:text-4xl md:text-5xl font-bold text-center mb-3 text-[#0f4c5c]"
            type="slideUp"
            delay={200}
          />
          <p className="text-[#334e68] max-w-xl sm:max-w-2xl mx-auto text-sm sm:text-base font-medium px-2">
